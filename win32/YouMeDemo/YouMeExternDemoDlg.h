...
class CYouMeExternDemoDlg : public CDialogEx
{
// 构造
public:
	CYouMeExternDemoDlg(CWnd* pParent = NULL);	// 标准构造函数
...
public:
	...
	YouMeExternVideoDlg * m_YouMeVideoDlg;
...
extern CYouMeExternDemoDlg* YouMeExternDemoDlg;